إليك ملف الـ `README.md` مكتوباً باحترافية وبتنسيق Markdown ممتاز وجاهز للاستخدام مباشرة في مستودع GitHub الخاص بك. تم ترتيب وتنسيق كافة البيانات التي ذكرتها لتظهر بشكل جذاب ومنظم.
